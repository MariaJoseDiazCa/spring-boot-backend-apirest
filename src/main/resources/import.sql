...
INSERT INTO `usuarios` (username, password, enabled, nombre, apellido, email) VALUES ('andres','$2a$10$O9QehLQio0CgJue1BZ/Qm.Pg1VKzGDqHi0pHqTafgCBASMP0qK.Ku',1, 'Andres', 'Guzman','profesor@bolsadeideas.com');
INSERT INTO `usuarios` (username, password, enabled, nombre, apellido, email) VALUES ('admin','$2a$10$GVLpJ.OA1Kqikxphi1CdI.lPaZVAuuyVxs3jtwEAUKMVRtR3W0TPe',1, 'John', 'Doe','jhon.doe@bolsadeideas.com');
